...
`,u=({children:e,loading:o,disabled:i,success:l,size:a="lg",loadingText:n="Loading...",as:c,onClick:s,...d})=>{let v="a"===c,h=!(!o&&!i);return(0,r.jsx)(x,{as:c,disabled:v?void 0:h,"aria-disabled":v?h:void 0,$success:l,$size:a,onClick:e=>{v&&h?e.preventDefault():s?.(e)},...d,children:o?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.B,{}),n?(0,r.jsx)("span",{style:{marginLeft:"8px"},children:n}):null]}):e})},f=(0,o.styled)(p)`
  position: relative;
...
`,x=(0,o.styled)(p)`
  ...
  ${e=>e.disabled&&o.css`
    ...
    `}
`,A=({children:e,loading:o,disabled:i,size:l="lg",loadingText:a="Loading...",as:n,onClick:c,...s})=>{let d="a"===n,v=!(!o&&!i);return(0,r.jsx)(y,{as:n,disabled:d?void 0:v,"aria-disabled":d?v:void 0,$size:l,onClick:e=>{d&&v?e.preventDefault():c?.(e)},...s,children:o?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.B,{}),a?(0,r.jsx)("span",{style:{marginLeft:"8px"},children:a}):null]}):e})},b=({children:e,loading:o,disabled:i,size:l="lg",loadingText:a="Loading...",as:n,onClick:c,...s})=>{let d="a"===n,v=!(!o&&!i);return(0,r.jsx)(m,{as:n,disabled:d?void 0:v,"aria-disabled":d?v:void 0,$size:l,onClick:e=>{d&&v?e.preventDefault():c?.(e)},...s,children:o?(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(t.B,{}),a?(0,r.jsx)("span",{style:{marginLeft:"8px"},children:a}):null]}):e})},y=(0,o.styled)(p)`
  && {
    border-width: 1px;
    border-style: solid;
...
`,j=({backFn:e})=>(0,r.jsx)("div",{children:(0,r.jsx)(B,{onClick:e,children:(0,r.jsx)(l.default,{height:"16px",width:"16px",strokeWidth:2})})}),k=({infoFn:e})=>(0,r.jsx)("div",{children:(0,r.jsx)(M,{"aria-label":"info",onClick:e,children:(0,r.jsx)(a.default,{height:"22px",width:"22px",strokeWidth:2})})}),E=e=>(0,r.jsx)("div",{children:(0,r.jsx)(B,{"aria-label":"close modal",onClick:e.onClose,children:(0,r.jsx)(c,{height:"16px",width:"16px",strokeWidth:2})})}),B=o.styled.button`
  && {
    cursor: pointer;
    display: flex;
    opacity: 0.6;
...
`,H=o.styled.div`
  ...
  font-weight: 400;
  color: var(--privy-color-foreground);
`;e.s(["B",0,({className:e})=>{let{appearance:o}=(0,i.u)();return(0,r.jsx)(g,{className:e,children:o.footerLogo??(0,r.jsx)(h,{href:"https://privy.io/?utm_source=module&utm_medium=module&utm_campaign=registration_module",target:"_blank",rel:"noopener noreferrer",id:"protected-by-privy",children:(0,r.jsx)(d,{color:"currentColor",height:13,width:150})})})},"E",0,({children:e,onClick:o,disabled:i,isSubmitting:l,...a})=>(0,r.jsxs)(w,{$isSubmitting:l,onClick:o,disabled:i,...a,children:[(0,r.jsx)("span",{children:e}),(0,r.jsx)("span",{children:(0,r.jsx)(t.B,{})})]}),"M",0,({backFn:e,infoFn:o,onClose:t,title:l,eyebrow:a,closeable:n=!0,className:c})=>{let{closePrivyModal:d}=(0,s.u)(),v=(0,i.u)();return(0,r.jsxs)(S,{className:c,children:[(0,r.jsxs)(L,{children:[e&&(0,r.jsx)(j,{backFn:e}),a&&(0,r.jsx)(H,{children:a}),!a&&l&&(0,r.jsx)(F,{id:"privy-dialog-title",children:l}),(0,r.jsx)("div",{style:{height:24}}),o&&(0,r.jsx)(k,{infoFn:o})]}),(0,r.jsx)(z,{children:!v.render.standalone&&n&&(0,r.jsx)(E,{onClose:t||(()=>d())})})]})},"P",0,u,"S",0,A,"T",0,function({app:{legal:{privacyPolicyUrl:e,termsAndConditionsUrl:o,requireUsersAcceptTerms:i}},alwaysShowImplicitConsent:t}){let l=!(!e||!o);return(!i||t)&&(o||e)?(0,r.jsxs)(v,{children:["By logging in I agree to the"," ",o&&(0,r.jsx)("a",{href:o,target:"_blank",children:l?"Terms":"Terms of Service"}),l&&" & ",e&&(0,r.jsx)("a",{href:e,target:"_blank",children:"Privacy Policy"})]}):(0,r.jsx)(v,{})},"a",0,({variant:e="primary",size:o="lg",children:i,success:t,...l})=>{switch(e){case"secondary":return(0,r.jsx)(A,{size:o,...l,children:i});case"error":return(0,r.jsx)(A,{$warn:!0,size:o,...l,children:i});case"muted":return(0,r.jsx)(b,{size:o,...l,children:i});default:return(0,r.jsx)(u,{size:o,success:t,...l,children:i})}},"b",0,g,"c",0,({children:e,loading:o,disabled:i,...l})=>(0,r.jsx)(f,{disabled:i,...l,children:o?(0,r.jsx)(t.B,{color:"var(--privy-color-foreground-accent)"}):e}),"d",0,C,"e",0,b],837008)},727108,e=>{"use strict";var r=e.i(843476),o=e.i(271645),i=e.i(600476),t=e.i(319539),l=e.i(652038),a=e.i(466895),n=e.i(830098),c=e.i(118364),s=e.i(662123),d=e.i(595693),v=e.i(346146),h=e.i(824434),g=e.i(520183),p=e.i(154003),u=e.i(385171);e.i(123287),e.i(437206),e.i(33750),e.i(610760);let f=({style:e})=>(0,r.jsx)(l.default,{style:{color:"var(--privy-color-error)",...e}}),x={google:{name:"Google",component:t.G},discord:{name:"Discord",component:t.D},github:{name:"Github",component:t.b},linkedin:{name:"LinkedIn",component:t.L},twitter:{name:"Twitter",component:t.a},spotify:{name:"Spotify",component:t.S},instagram:{name:"Instagram",component:t.I},tiktok:{name:"Tiktok",component:t.T},line:{name:"LINE",component:a.L},twitch:{name:"Twitch",component:a.T},apple:{name:"Apple",component:t.A},telegram:{name:"Telegram",component:n.T}},A=({iconUrl:e,...r})=>o.default.createElement("svg",{width:"33",height:"32",viewBox:"0 0 33 32",fill:"none",xmlns:"http://www.w3.org/2000/svg",...r},o.default.createElement("foreignObject",{x:"2",y:"2",width:"29",height:"28"},o.default.createElement("img",{src:e,width:"29",height:"28",style:{display:"block",objectFit:"contain",borderRadius:"4px"},alt:"Provider icon"}))),b=(e,r)=>{if(e in x)return x[e];if((0,i.i)(e)&&r){let i=r.find(r=>r.provider===e);if(i)return{name:i.provider_display_name,component:e=>o.default.createElement(A,{...e,iconUrl:i.provider_icon_url})}}return{name:"Unknown",component:f}},y=({providerName:e,ProviderLogo:o,success:i,errorMessage:t,onRetry:l})=>{let a=i?`Successfully connected with ${e}`:t?t.message:`Verifying connection to ${e}`;return(0,r.jsx)(g.S,{title:a,subtitle:i?"You're good to go!":t?t.detail:"Just a few moments more",icon:o,iconVariant:"loading",iconLoadingStatus:{success:i,fail:!!t},secondaryCta:t?.retryable&&l?{label:"Retry",onClick:l}:void 0,watermark:!0})},m={component:()=>{let{authenticated:e,logout:t,ready:l,user:a}=(0,i.u)(),{setModalData:n,navigate:g,resetNavigation:f}=(0,v.u)(),x=(0,c.u)(),{getAuthMeta:A,initLoginWithOAuth:m,loginWithOAuth:C,updateWallets:w,setReadyToTrue:j,closePrivyModal:k,createAnalyticsEvent:E}=(0,d.u)(),[B,M]=(0,o.useState)(!1),[S,L]=(0,o.useState)(void 0),z=A()?.provider||"google",{name:F,component:H}=b(z,x.customOAuthProviders);return(0,o.useEffect)(()=>{C(z).then(()=>{M(!0),j(!0)}).catch(e=>{if(j(!1),e?.privyErrorCode===s.a.ALLOWLIST_REJECTED)return L(void 0),f(),void g("AllowlistRejectionScreen");if(e?.privyErrorCode===s.a.USER_LIMIT_REACHED)return console.error(new s.j(e).toString()),L(void 0),f(),void g("UserLimitReachedScreen");if(e?.privyErrorCode===s.a.USER_DOES_NOT_EXIST)return L(void 0),f(),void g("AccountNotFoundScreen");if(e?.privyErrorCode===s.a.ACCOUNT_TRANSFER_REQUIRED&&e.data?.data?.nonce)return L(void 0),f(),n({accountTransfer:{nonce:e.data?.data?.nonce,account:e.data?.data?.subject,displayName:e.data?.data?.account?.displayName,linkMethod:A()?.provider,embeddedWalletAddress:e.data?.data?.otherUser?.embeddedWalletAddress,oAuthUserInfo:e.data?.data?.otherUser?.oAuthUserInfo}}),void g("LinkConflictScreen");let{retryable:r,detail:o}=function(e,r,o){let i={detail:"",retryable:!1},t=(0,p.e)(r);if(e?.privyErrorCode===s.a.LINKED_TO_ANOTHER_USER&&(i.detail="This account has already been linked to another user."),e?.privyErrorCode===s.a.INVALID_CREDENTIALS&&(i.retryable=!0,i.detail="Something went wrong. Try again."),e.privyErrorCode===s.a.OAUTH_USER_DENIED&&(i.detail=`Retry and check ${t} to finish connecting your account.`,i.retryable=!0),e?.privyErrorCode===s.a.TOO_MANY_REQUESTS&&(i.detail="Too many requests. Please wait before trying again."),e?.privyErrorCode===s.a.TOO_MANY_REQUESTS&&e.message.includes("provider rate limit")){let e=b(r,o).name;i.detail=`Request limit reached for ${e}. Please wait a moment and try again.`}if(e?.privyErrorCode===s.a.OAUTH_ACCOUNT_SUSPENDED){let e=b(r,o).name;i.detail=`Your ${e} account is suspended. Please try another login method.`}return e?.privyErrorCode===s.a.CANNOT_LINK_MORE_OF_TYPE&&(i.detail="You cannot authorize more than one account for this user."),e?.privyErrorCode===s.a.OAUTH_UNEXPECTED&&r.startsWith("privy:")&&(i.detail="Something went wrong. Please try again."),i}(e,z,x.customOAuthProviders);L({retryable:r,detail:o,message:"Authentication failed"})}).finally(()=>{(0,u.k)()})},[F,z]),(0,o.useEffect)(()=>{if(l&&e&&B&&a){if(x?.legal.requireUsersAcceptTerms&&!a.hasAcceptedTerms){let e=setTimeout(()=>{g("AffirmativeConsentScreen")},c.r);return()=>clearTimeout(e)}if((0,h.s)(a,x.embeddedWallets)){let e=setTimeout(()=>{n({createWallet:{onSuccess:()=>{},onFailure:e=>{console.error(e),E({eventName:"embedded_wallet_creation_failure_logout",payload:{error:e,provider:z,screen:"OAuthStatusScreen"}}),t()},callAuthOnSuccessOnClose:!0}}),g("EmbeddedWalletOnAccountCreateScreen")},c.r);return()=>clearTimeout(e)}{let e=setTimeout(()=>k({shouldCallAuthOnSuccess:!0,isSuccess:!0}),c.r);return w(),()=>clearTimeout(e)}}},[l,e,B,a]),(0,r.jsx)(y,{providerName:F,ProviderLogo:H,success:B,errorMessage:S,onRetry:S?.retryable?()=>{(0,u.k)(),m(z),L(void 0)}:void 0})},isShownBeforeReady:!0};e.s(["OAuthStatusScreen",0,m,"OAuthStatusScreenView",0,y,"default",0,m])},241342,e=>{"use strict";var r=e.i(843476),o=e.i(271645),i=e.i(997053),t=e.i(737577),l=e.i(837008),a=e.i(632964);let n=i.styled.div`
  /* spacing tokens */
...
`,y=({children:e,...o})=>(0,r.jsx)(n,{children:(0,r.jsx)(c,{...o,children:e})}),m=i.styled.div`
  position: absolute;
  top: 0;
...
`,j=({step:e})=>e?(0,r.jsx)(m,{children:(0,r.jsx)(w,{pct:Math.min(100,e.current/e.total*100)})}):null;y.Header=({title:e,subtitle:o,icon:i,iconVariant:t,iconLoadingStatus:l,showBack:a,onBack:n,showInfo:c,onInfo:v,showClose:h,onClose:x,step:A,headerTitle:b,eyebrow:m,...C})=>(0,r.jsxs)(s,{...C,children:[(0,r.jsx)(d,{backFn:a?n:void 0,infoFn:c?v:void 0,onClose:h?x:void 0,title:b,eyebrow:m,closeable:h}),(i||t||e||o)&&(0,r.jsxs)(g,{children:[i||t?(0,r.jsx)(y.Icon,{icon:i,variant:t,loadingStatus:l}):null,!(!e&&!o)&&(0,r.jsxs)(p,{children:[e&&(0,r.jsx)(u,{children:e}),o&&(0,r.jsx)(f,{children:o})]})]}),A&&(0,r.jsx)(j,{step:A})]}),(y.Body=o.default.forwardRef(({children:e,...o},i)=>(0,r.jsx)(v,{ref:i,...o,children:e}))).displayName="Screen.Body",y.Footer=({children:e,...o})=>(0,r.jsx)(h,{id:"privy-content-footer-container",...o,children:e}),y.Actions=({children:e,...o})=>(0,r.jsx)(k,{...o,children:e}),y.HelpText=({children:e,...o})=>(0,r.jsx)(E,{...o,children:e}),y.FooterText=({children:e,...o})=>(0,r.jsx)(B,{...o,children:e}),y.Watermark=()=>(0,r.jsx)(C,{}),y.Icon=({icon:e,variant:i="subtle",loadingStatus:l})=>"logo"===i&&e?(0,r.jsx)(A,"string"==typeof e?{children:(0,r.jsx)("img",{src:e,alt:""})}:o.default.isValidElement(e)?{children:e}:{children:o.default.createElement(e)}):"loading"===i?e?(0,r.jsx)(b,{children:(0,r.jsxs)("div",{style:{display:"flex",alignItems:"center",justifyContent:"center"},children:[(0,r.jsx)(t.C,{success:l?.success,fail:l?.fail}),"string"==typeof e?(0,r.jsx)("span",{style:{background:`url('${e}') 0 0 / contain`,height:"38px",width:"38px",borderRadius:"6px",margin:"auto",backgroundSize:"contain"}}):o.default.isValidElement(e)?o.default.cloneElement(e,{style:{width:"38px",height:"38px"}}):o.default.createElement(e,{style:{width:"38px",height:"38px"}})]})}):(0,r.jsx)(x,{$variant:i,children:(0,r.jsx)(a.N,{size:"64px"})}):(0,r.jsx)(x,{$variant:i,children:e&&("string"==typeof e?(0,r.jsx)("img",{src:e,alt:"",style:{width:"32px",height:"32px",borderRadius:"6px"}}):o.default.isValidElement(e)?e:o.default.createElement(e,{width:32,height:32,stroke:(()=>{switch(i){case"success":return"var(--privy-color-icon-success)";case"warning":return"var(--privy-color-icon-warning)";case"error":return"var(--privy-color-icon-error)";default:return"var(--privy-color-icon-muted)"}})(),strokeWidth:2}))});let k=i.styled.div`
  width: 100%;
  display: flex;
  flex-direction: column;
...
`;e.s(["S",0,y])},520183,e=>{"use strict";var r=e.i(843476),o=e.i(837008),i=e.i(241342);e.s(["S",0,({primaryCta:e,secondaryCta:t,helpText:l,footerText:a,watermark:n=!0,children:c,...s})=>{let d=e||t?(0,r.jsxs)(r.Fragment,{children:[e&&(()=>{let{label:i,...t}=e,l=t.variant||"primary";return(0,r.jsx)(o.a,{...t,variant:l,style:{width:"100%",...t.style},children:i})})(),t&&(()=>{let{label:e,...i}=t,l=i.variant||"secondary";return(0,r.jsx)(o.a,{...i,variant:l,style:{width:"100%",...i.style},children:e})})()]}):null;return(0,r.jsxs)(i.S,{id:s.id,className:s.className,children:[(0,r.jsx)(i.S.Header,{...s}),c?(0,r.jsx)(i.S.Body,{children:c}):null,l||d||n?(0,r.jsxs)(i.S.Footer,{children:[l?(0,r.jsx)(i.S.HelpText,{children:l}):null,d?(0,r.jsx)(i.S.Actions,{children:d}):null,n?(0,r.jsx)(i.S.Watermark,{}):null]}):null,a?(0,r.jsx)(i.S.FooterText,{children:a}):null]})}])},154003,e=>{"use strict";e.s(["e",0,function(e){return e.charAt(0).toUpperCase()+e.slice(1)}])},632964,e=>{"use strict";var r=e.i(843476),o=e.i(997053);let i=o.styled.div`
